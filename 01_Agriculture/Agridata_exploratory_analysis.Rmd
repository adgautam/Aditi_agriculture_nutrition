...
```{r}
agri_corr <- agri
if(agri_corr$Crop == "Sugarcane" && agri_corr$Crop_Year == 2011 && agri_corr$State_name == "Punjab"){
  agri_corr$Area <- agri_corr$Area*1000
  agri_corr$Production_by_Area <- agri_corr$Area/1000
  }
```
